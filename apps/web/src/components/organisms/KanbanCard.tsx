    ...
    >
      ...
      <div className="flex items-center justify-between gap-3">
        <div className="flex min-w-0 items-center gap-2.5">
          <span className="h-5 w-5 shrink-0 rounded-full border-2 border-blue-500 bg-white dark:border-blue-400 dark:bg-slate-900" />
          <span className="shrink-0 text-sm font-semibold text-gray-500 dark:text-slate-400">{cardCode}</span>
          <span className="max-w-20 truncate rounded-md bg-blue-50 px-2.5 py-1 text-sm font-semibold text-blue-600 dark:bg-blue-500/15 dark:text-blue-300">
            {labelText}
          </span>
        </div>
        <button
      ...
      <div className="mt-4 flex flex-wrap items-center gap-x-3 gap-y-2 text-sm font-medium text-gray-500 dark:text-slate-400">
        <span className="flex min-w-0 items-center gap-1.5">
          <i className="ti ti-calendar text-base text-gray-500 dark:text-slate-400" />
        ...
        <span className="flex shrink-0 items-center gap-1.5">
          <i className="ti ti-list-check text-base text-gray-500 dark:text-slate-400" />
